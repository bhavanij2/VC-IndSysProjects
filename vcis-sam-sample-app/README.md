...
This is a sample template for vcis-sam-sample-app - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name vcis-sam-sample-app \
...
```bash
sam logs -n HelloWorldFunction --stack-name vcis-sam-sample-app --tail
```
...
```bash
aws cloudformation delete-stack --stack-name vcis-sam-sample-app
```
